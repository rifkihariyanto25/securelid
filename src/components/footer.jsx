  ...
  return (
    ...
    >
      <div className="relative">
        <div className="relative z-10 max-w-6xl mx-auto py-16 px-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:space-x-8">
            {/* Logo dan Deskripsi */}
            <div className="mb-8 md:mb-0 md:w-2/5 text-left">
            ...
            <div className="md:w-1/5 text-left">
              <h4 className="text-xl font-semibold text-white mb-6">Follow Kami</h4>
          ...
          <div className="mt-16 pt-8 border-t border-gray-700 text-center md:text-left">
